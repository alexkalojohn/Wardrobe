...
import com.example.myapplication.models.ClothingItem;
import com.example.myapplication.database.DatabaseContract.OutfitEntry;
import com.example.myapplication.database.DatabaseContract.OutfitClothingEntry;

// Κάνουμε import το συμβόλαιο που φτιάξαμε πριν
import com.example.myapplication.database.DatabaseContract.ClothingEntry;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(SQL_CREATE_ENTRIES); // Ο πίνακας ρούχων που φτιάξαμε πριν
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Εκτελείται αν αλλάξεις τη version της βάσης
    ...
    // 2. Πίνακας Σύνδεσης (Ποιο ρούχο ανήκει σε ποιο σύνολο)
